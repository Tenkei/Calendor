...
public class PersianCalendar extends GregorianCalendar {
	 ...
	 * @param persianDay
	 */
	public PersianCalendar setPersianDate(int persianYear, int persianMonth, int persianDay) {
	...
	public boolean equals(PersianCalendar persianDate) {
		return this.getPersianDay() == persianDate.getPersianDay()
				&& this.getPersianMonth() == persianDate.getPersianMonth()
				&& (this.getPersianYear() == persianDate.getPersianYear() || this.getPersianYear() == -1);
	}
