...
package com.esbati.keivan.persiancalendar.Components.Cell;
...
import com.esbati.keivan.persiancalendar.Components.Views.FrameLayoutFixed;
...
public class TextDetailSettingsCell extends FrameLayoutFixed {
    ...
    public TextDetailSettingsCell(Context context) {
        ...
        addView(textView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.RIGHT | Gravity.TOP, 17, 10, 17, 0));
        ...
        addView(valueTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.RIGHT | Gravity.TOP, 17, 35, 17, 0));
    }
